    ...
    var _ = {
        ...
        loopFix: function (e) {
            ...
            if (z < y) {
                ...
                (I = Math.max(z - (T - 2 * y), b)),
                    M && (I = Math.max(I, w - T + v + 1));
                for (let e = 0; e < I; e += 1) {
                    const t = e - Math.floor(e / T) * T;
                    E
                        ? c.forEach((e, s) => {
    ...
    const xe = [
        function (e) {
            ...
            function c(e, t, a) {
                ...
                const I = o ? -g.length : 0,
                    z = o ? 2 * g.length : g.length;
                for (let t = I; t < z; t += 1)
                    if (t >= S && t <= T) {
                        const s = A(t);
                        void 0 === h || e
            ...
            function p() {
                ...
                c.forEach((e, r) => {
                    if (
                        ('fraction' === s.type &&
                            (e
                                .querySelectorAll(ue(s.currentClass))
                                .forEach((e) => {
                            ...
                            e
                                .querySelectorAll(ue(s.totalClass))
                                .forEach((e) => {
                        ...
                        'horizontal' === i ? (n = r) : (l = r),
                            e
                                .querySelectorAll(ue(s.progressbarFillClass))
                                .forEach((e) => {
        ...
        function (e) {
            ...
            function L() {
                ...
                t.params.uniqueNavElements &&
                    ...
                    i &&
                        ((r = i.querySelector(
                            ue(t.params.scrollbar.dragClass)
                        )),
                        r ||
            ...
            s({
                ...
                i('init', () => {
                    !1 === t.params.scrollbar.enabled ? A() : (L(), b(), g());
                }),
                i(
        ...
        function (e) {
            ...
            function D(e) {
                ...
                let i, r, o, d, c, p, u, m, h, g, y, x, S, T, C, L, P, A;
                t.params.cssMode &&
                    ((t.wrapperEl.style.overflow = 'hidden'),
                    ...
                    !e || (1 === l && z)
                        ...
                        : ((P = v.slideEl.offsetWidth),
                          ...
                          'number' == typeof b.currentY
                              ? ((u = (b.currentX * s.scale) / I),
                                (m = (b.currentY * s.scale) / I))
            ...
            function B() {
                ...
                t.wrapperEl.addEventListener('pointerdown', P, s),
                    ...
                    t.wrapperEl.addEventListener('pointermove', k, a);
            }
            function Y() {
                const e = t.zoom;
                if (!e.enabled) return;
                ...
                t.wrapperEl.removeEventListener('pointerdown', P, s),
                    ...
                    t.wrapperEl.removeEventListener('pointermove', k, a);
            }
        ...
        function (e) {
            ...
            function w(e) {
                ...
                if (
                    ...
                    e.target.matches(ue(t.params.pagination.bulletClass))
                ) {
                    if (
                        t.navigation &&
                        t.navigation.prevEl &&
                    ...
                    t.pagination &&
                        a.matches(ue(t.params.pagination.bulletClass)) &&
                        a.click();
                }
            }
            function b() {
            ...
            const i = (e, s) => {
                let a = t.isHorizontal()
                    ...
                    i = t.isHorizontal()
                        ? e.querySelector('.swiper-slide-shadow-right')
                        : e.querySelector('.swiper-slide-shadow-bottom');
                a || (a = Ee('flip', e, t.isHorizontal() ? 'left' : 'top')),
                    i ||
                        (i = Ee(
                            'flip',
                            e,
            ...
            we({
                ...
                setTransition: (e) => {
                    ...
                    s.forEach((t) => {
                        ...
                        ye({ swiper: t, duration: e, transformElements: s });
                },
                recreateShadows: () => {
                    t.params.flipEffect,
                        t.slides.forEach((e) => {
    ...
    breakpoints: {
        0: {
            ...
            grid: {
                ...
                fill: 'row', // Додатково: щоб заповнювало по рядках
            },
        },
        768: {
            slidesPerView: 4,
...
const buttons = document.querySelectorAll('.soc__wrapper');
buttons.forEach((e) => {
    e.addEventListener('click', () => {
        e.classList.add('activ'),
            buttons.forEach((t) => {
                t !== e && t.classList.remove('activ');
            });
    });
});
const tarifs = document.querySelectorAll('.tarif__card');
tarifs.forEach((e) => {
    e.addEventListener('click', () => {
        e.classList.add('activity'),
            tarifs.forEach((t) => {
                t !== e && t.classList.remove('activity');
            });
    });
}),
    document.querySelectorAll('.accordeon__triger').forEach((e) => {
        e.addEventListener('click', () => {
            e.parentNode.classList.toggle('accordeon__item--active');
        });
    }),
    document.querySelectorAll('.menuButton').forEach((e, t) => {
        e.addEventListener('click', () => {
            const e = document.querySelectorAll('.popupMenu');
            let s = !1;
            e.forEach((e, a) => {
                a === t
                    ? (e.classList.toggle('show'),
                      e.classList.contains('show') && (s = !0))
    ...
    document.querySelectorAll('.zakazBtn').forEach((e, t) => {
        e.addEventListener('click', () => {
            const e = document.querySelectorAll('.popupZakaz');
            let s = !1;
            e.forEach((e, a) => {
                a === t
                    ? (e.classList.toggle('show'),
